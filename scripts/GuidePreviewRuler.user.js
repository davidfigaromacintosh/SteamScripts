...
(()=>{
  $J('.subSections').prepend('<div style="height: 14px;"></div><a id="DFM_TRuler"class="btn_darkblue_white_innerfade btn_border_2px btn_medium"style="user-select: none;"><span>Toggle Ruler</span></a>');
  $J('.subSections').attr({'style':'font-family: "Motiva Sans", Arial, Helvetica, sans-serif; font-size: 14px; color: #fff;'});
  $J('.subSections').prepend('<div id="DFM_GRuler"style="position: absolute; margin-left: 0px; width: 638px; height: 0; z-index: -1; background-color: rgba(0, 20, 40, 0.5); background-image: '+
